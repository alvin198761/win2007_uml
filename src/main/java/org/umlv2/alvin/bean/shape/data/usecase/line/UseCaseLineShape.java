package org.umlv2.alvin.bean.shape.data.usecase.line;
...
public class UseCaseLineShape extends BaseLineShape {

    private static final long serialVersionUID = 1L;

    public UseCaseLineShape() {
        type = ShapeHelper.USECASE_LINE;
        text = "Line";
    }
